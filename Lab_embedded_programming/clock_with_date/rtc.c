...
// Obs: Esta biblioteca ainda não possui as configurações da PICGenius
// A PICGenius utiliza o circuito integrado DS1307 que comunica por I2C 
// A placa Exsto utiliza o circuito integrado HT1380
